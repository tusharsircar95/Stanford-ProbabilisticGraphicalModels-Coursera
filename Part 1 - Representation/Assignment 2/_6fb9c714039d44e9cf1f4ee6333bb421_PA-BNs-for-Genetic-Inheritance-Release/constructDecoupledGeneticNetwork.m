...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
for i = 1:numPeople
	if pedigree.parents(i,1) == 0 % no parents
	...
	if pedigree.parents(i,1) != 0 % yes parents
		parent1 = pedigree.parents(i,1);
		parent2 = pedigree.parents(i,2);
		factorList(i) = childCopyGivenParentalsFactor(numAlleles,i,parent1,numPeople+parent1);
		factorList(numPeople+i) = childCopyGivenParentalsFactor(numAlleles,numPeople+i,parent2,numPeople+parent2);
	end
end
