...
phenotypeFactor.var = [phenotypeVar,genotypeVar]; % Phenotype | Genotype probability
% Fill in phenotypeFactor.card.  This should be a 1-D row vector.
phenotypeFactor.card = [2, 3]; % Two possible phenotypes and three possible genotypes

phenotypeFactor.val = zeros(1, prod(phenotypeFactor.card));
% Replace the zeros in phentoypeFactor.val with the correct values.
if isDominant == 1
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,1],1); % AA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,1],0); % AA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,2],1); % Aa /aA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,2],0); % Aa /aA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,3],0); % aa
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,3],1); % aa
end
if isDominant == 0
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,1],0); % AA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,1],1); % AA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,2],0); % Aa /aA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,2],1); % Aa /aA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,3],1); % aa
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,3],0); % aa
end
