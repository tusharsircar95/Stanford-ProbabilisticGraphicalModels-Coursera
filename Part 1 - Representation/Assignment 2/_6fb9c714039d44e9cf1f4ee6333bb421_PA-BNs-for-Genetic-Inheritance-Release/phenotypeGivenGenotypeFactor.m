...
assignmentsHavingTrait = assignments( assignments(:,1) == 1, :);
assignmentsNotHavingTrait = assignments( assignments(:,1) == 2, :);

phenotypeFactor = SetValueOfAssignment(phenotypeFactor,assignmentsHavingTrait,alphaList);
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,assignmentsNotHavingTrait,1-alphaList);
