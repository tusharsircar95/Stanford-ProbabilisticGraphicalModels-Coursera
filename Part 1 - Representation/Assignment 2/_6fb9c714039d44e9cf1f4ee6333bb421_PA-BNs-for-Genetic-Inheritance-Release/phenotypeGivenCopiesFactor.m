...
for i = 1:numAlleles
	for j = 1:numAlleles
		probabilityForTrait = alphaList(allelesToGenotypes(i,j));
		phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[1,i,j],probabilityForTrait);
		phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[2,i,j],1-probabilityForTrait);
	end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%