...
JointObservedMarginal = FactorMarginalization(JointObserved,setdiff(JointObserved.var,V));
JointObservedMarginal.val = JointObservedMarginal.val / sum(JointObservedMarginal.val);
M = JointObservedMarginal;
